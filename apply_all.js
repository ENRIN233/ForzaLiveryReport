...
let m=false;
if(existingCount!==dsCount||!/'\d{2}/.test(la.slice(la.indexOf('const CAR_NAME_MAP = {'),la.indexOf('};',la.indexOf('const CAR_NAME_MAP = {'))+2))||!la.includes('Porsche 911 Rallye')||!la.includes("911 GT3 RS '23")||!la.includes('Formula Drift #98 BMW')){
